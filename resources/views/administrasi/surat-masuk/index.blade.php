    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card-header text-end">
                ...
                <a href="{{ url('administrasi/surat-masuk/create') }}" class="btn btn-primary">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="dropdown-item btn-detail-surat"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-4">
                            ...
                            <a href="{{ url('administrasi/surat-masuk/create') }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <h6>Lampiran:</h6>
                        <a href="#" target="_blank" id="detailLampiran" class="btn btn-sm btn-outline-info d-none">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        detailModal.addEventListener('show.bs.modal', function(event) {
            ...
            document.getElementById('detailPrioritas').innerHTML = `<span class="badge bg-${badgeClass}">${prioritas}</span>`;
