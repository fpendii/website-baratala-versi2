...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('administrasi/rencana/store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="judul_rencana" name="judul_rencana"
                        ...
                        value="{{ old('judul_rencana') }}" placeholder="Masukkan judul rencana" required>
                    @error('judul_rencana')
                ...
                <a href="{{ url('administrasi/rencana') }}" class="btn btn-outline-secondary">Batal</a>
            </form>
        </div>
    </div>
</div>
